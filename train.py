...
def train(hyp, opt, device, callbacks):
    ...
    print(f"\033[94mtrain_path:{train_path}\033[0m")
    print(f"\033[94mval_path:{val_path}\033[0m")
    is_coco = isinstance(val_path, str) and val_path.endswith("myyolo/val.txt")  # COCO dataset
    ...
    hyp["cls"] *= nc / 20 * 3 / nl  # scale to classes and layers
...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default=ROOT / "models/yolov5s_CBST.yaml", help="model.yaml path")
